...
export async function createQwenStream(
  ...
  const payload: any = {
    ...
    messages: [{
      ...
      feature_config: { thinking_enabled: true, output_schema: 'phase', research_mode: 'normal', auto_thinking: false, thinking_mode: 'Thinking', thinking_format: 'summary', auto_search: false },
